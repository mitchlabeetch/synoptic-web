...
export function MarketingHeader() {
  ...
  return (
    <header className="px-4 md:px-6 h-20 flex items-center border-b bg-background/80 backdrop-blur-xl sticky top-0 z-[1000] transition-all duration-500">
      ...
      {/* Desktop Nav */}
      <nav className="ml-8 hidden xl:flex gap-6 items-center">
        <Link 
          className={cn(
        ...
        <WebsiteCarbonBadge className="hidden 2xl:flex" />
        <LocaleSwitcher />
      ...
      <div className="ml-auto flex xl:hidden items-center gap-4">
        <LocaleSwitcher />
        <button 
