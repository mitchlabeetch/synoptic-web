...
// PURPOSE: Auto-generates Credits/Attribution page for 🟡 Yellow sources
 ...
 * This page is automatically appended to projects that use 🟡 Attribution sources
 */
export function generateCreditsPage(sources: CreditsSource[]): IngestedPage {
  ...
  lines.push({
    id: 'credits-footer',
    type: 'text',
    L1: `Credits generated by Synoptic on ${new Date().toLocaleDateString()}.`,
    L2: '',
  });
